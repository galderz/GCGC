...
def get_parsing_groups():
    ...
    space_or_other_separator = "(?:\s|:\s)", None, None # space
    ...
    event_type = " ((?:Pause(?=.*ms))|(?:Concurrent(?=.*ms))|(?:Garbage Collection)|(?:Full GC)|(?:Incremental GC)) ", "EventType", str  # Concurrent
                                                                                                                                         # Pause
    ...
    # TODO scale the memory usage to megabytes and set it
